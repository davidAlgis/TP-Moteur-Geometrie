...
\tipbox{Notez que ce n'est pas très pratique d'utiliser les coordonnées « \textit{screen} » de \texttt{pygame}, peut-être est-ce le moment d'utiliser votre classe matrice $2x2$ pour « changer de base de coordonnées ».}
